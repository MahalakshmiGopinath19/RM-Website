...
export default async function BlogDetailPage({
  ...
  return (
    <div className="bg-[#FDFBF8] min-h-screen pt-20">
        ...
        <header className="text-center mb-10">
          ...
          <div className="flex flex-wrap justify-center gap-4 text-gray-500 text-sm mt-4">
            <span className="flex items-center gap-1">
              <FaCalendarAlt className="text-[#E0A36A]" />
            ...
            <span className="flex items-center gap-1">
              <FaClock className="text-[#E0A36A]" />
              {readTime} min read
            </span>
          </div>
          <div className="mt-6 text-left bg-[#fdf8f5] border-l-4 border-[#E0A36A] rounded-r-xl p-4 text-gray-700 text-lg font-medium">
        ...
        <section className="bg-gray-50/80 py-12 md:py-16 border-t border-gray-200 mt-12">
          <div className="container mx-auto px-4">
            <h4 className="text-2xl md:text-3xl font-bold text-center mb-8">
              More <span className="bg-gradient-to-r from-[#E0A36A] to-[#9C5B5A] bg-clip-text text-transparent">Case Studies</span>
            </h4>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {recentBlogs.map((recent) => (
                <div key={recent.id} className="bg-white rounded-2xl border border-gray-100 overflow-hidden transition-all hover:-translate-y-1.5 hover:shadow-lg hover:border-[#E0A36A]/50">
                  ...
                  <div className="p-4 flex flex-col flex-1">
                    ...
                    <Link
                      href={`/blog/${recent.id}`}
                      className="mt-auto font-bold text-sm text-gray-900 inline-flex items-center gap-1.5 border-b-2 border-[#E0A36A] pb-1 w-fit transition-all hover:text-[#E0A36A] hover:gap-2.5"
                    >
