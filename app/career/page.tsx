      ...
      <div className="bg-white text-gray-900 min-h-screen">
            ...
            <motion.div initial="hidden" animate={heroInView ? 'visible' : 'hidden'} variants={stagger}
              ...
              <div className="lg:col-span-7 text-center lg:text-left">
                <motion.span variants={fadeUp} className="inline-block bg-[#C9956C]/10 text-[#C9956C] border border-[#C9956C]/20 px-4 py-1.5 rounded-full text-xs font-display font-extrabold uppercase tracking-widest mb-4">
                  Careers at Vaave Digital
                </motion.span>

                <motion.h1 variants={fadeUp}
                  className="font-display text-white font-black leading-[0.95] mb-6 tracking-tight"
                  style={{ fontSize: 'clamp(3.2rem,7vw,5.5rem)', textShadow: '0 20px 60px rgba(0,0,0,0.45)' }}>
                  We Make{' '}
                  <span className="bg-gradient-to-r from-[#a86538] via-[#C9956C] to-[#e8c3b5] bg-clip-text text-transparent relative inline-block">
                    Creative
                  </span> <br />
                  Things Everyday.
                </motion.h1>
                <motion.p variants={fadeUp} className="text-[#acabcb] text-base md:text-lg max-w-xl mx-auto lg:mx-0 mb-8 font-medium leading-relaxed">
                  Join our team of innovators, developers, and digital marketing experts.
                </motion.p>
              ...
              <motion.div variants={fadeUp} className="lg:col-span-5 flex justify-center lg:justify-end w-full">
                <div className="relative w-full max-w-md md:max-w-xl lg:max-w-2xl">
                  ...
                  >
                    <FaWhatsapp className="text-lg" /><span>Join our team</span>
                  </motion.div>
                </div>
              </motion.div>
            </motion.div>
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger}
              ...
              {benefits.map((benefit, i) => (
                <motion.div key={i} variants={fadeUp}>
                  <div className="relative bg-[#050720] rounded-3xl p-6 sm:p-8 shadow-xl border border-slate-800 h-full flex flex-col justify-between">
                    <div>
                      <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-xl sm:text-2xl text-[#C9956C] mb-6">
                        <benefit.icon />
                      </div>
                      <h3 className="font-display text-xl sm:text-2xl font-bold text-white mb-3">{benefit.title}</h3>
                      <p className="text-[#acabcb] text-sm leading-relaxed font-medium">{benefit.desc}</p>
                    </div>
                  </div>
                </motion.div>
              ))}
        ...
        <div className="bg-[#050720] text-white py-14 relative overflow-hidden border-t border-slate-800/80">
          ...
          <div className="container mx-auto px-6 text-center relative z-10 max-w-4xl">
            ...
            <h3 className="font-display text-3xl md:text-4xl font-black mb-3 bg-gradient-to-r from-[#a86538] via-[#C9956C] to-[#e8c3b5] bg-clip-text text-transparent">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <a href="tel:+917305821333" className="flex items-center gap-2.5 bg-gradient-to-r from-[#a86538] via-[#C9956C] to-[#e8c3b5] hover:brightness-110 text-[#050720] px-7 py-3.5 rounded-full transition-all font-display font-black text-sm shadow-lg shadow-[#C9956C]/20">
                <FaPhoneAlt className="text-[#050720]" /> +91 73058 21333
              </a>
              <a href="mailto:info@vaavedigital.com" className="flex items-center gap-2.5 bg-gradient-to-r from-[#a86538] via-[#C9956C] to-[#e8c3b5] hover:brightness-110 text-[#050720] px-7 py-3.5 rounded-full transition-all font-display font-black text-sm shadow-lg shadow-[#C9956C]/20">
